...
input_signal = ['{0}/RelValQCD_Pt-15To7000_Flat_14TeV/crab_RelValQCD_Pt-15To7000_Flat_14TeV/180411_205427/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]

input_signal_0pu = ['{0}/RelValQCD_Pt-15To7000_Flat_14TeV/crab_RelValQCD_Pt-15To7000_Flat_14TeV/180411_205427/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]
...
output_file = 'cc_ntuple_qcd_200pu_tdr_layout.root'
output_tree = 'tree'
#
...
parameters.working_dir = '/uscms_data/d2/dnoonan/HGCAL/CMSSW_9_4_2/src/HGCTPG/FrontendNtuplizer/qcd_200pu_tdr_layout'
