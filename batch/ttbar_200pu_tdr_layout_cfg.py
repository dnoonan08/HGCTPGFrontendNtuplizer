...
input_signal = ['{0}/RelValTTbar_14TeV/crab_RelValTTbar_14TeV/180411_205247/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]

input_signal_0pu = ['{0}/RelValTTbar_14TeV/crab_RelValTTbar_14TeV/180411_205247/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]
...
output_file = 'cc_ntuple_ttbar_200pu_tdr_layout.root'
output_tree = 'tree'
#
...
parameters.working_dir = '/uscms_data/d2/dnoonan/HGCAL/CMSSW_9_4_2/src/HGCTPG/FrontendNtuplizer/ttbar_200pu_tdr_layout'
