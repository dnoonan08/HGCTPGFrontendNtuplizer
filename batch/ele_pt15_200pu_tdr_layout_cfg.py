...
input_signal = ['{0}/RelValSingleElectronPt15Eta1p7_2p7/crab_RelValSingleElectronPt15Eta1p7_2p7/180411_205406/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]

input_signal_0pu = ['{0}/RelValSingleElectronPt15Eta1p7_2p7/crab_RelValSingleElectronPt15Eta1p7_2p7/180411_205406/0000/ntuple_{1}.root'.format(basedir,i) for i in xrange(1,91)]
...
output_file = 'cc_ntuple_ele_pt15_200pu_tdr_layout.root'
output_tree = 'tree'
#
...
parameters.working_dir = '/uscms_data/d2/dnoonan/HGCAL/CMSSW_9_4_2/src/HGCTPG/FrontendNtuplizer/ele_pt15_200pu_tdr_layout'
